    ...
    <div class="card mt-4">
        ...
        <div class="card-body">
            ...
            <button type="button" class="btn btn-success float-end mb-3"
                    data-url="{{ route('admin.menus.create') }}">{{ __('cms.menus.add_new') }}</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary"
                            data-bs-dismiss="modal">{{ __('cms.menus.massage_cancel') }}</button>
                    <button type="button" class="btn btn-danger"
                            id="confirmDeleteMenu">{{ __('cms.menus.massage_delete') }}</button>
                </div>
            </div>
        </div>
    </div>
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            var editUrl = '{{ route('admin.menus.edit', ':id') }}'.replace(':id',
                                row.id);
                            return `
