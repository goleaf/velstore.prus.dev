        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.coupons.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="discount" id="discount" class="form-control" value="{{ old('discount') }}" step="0.01" min="0" required>
                ...
                <div class="mb-3">
                    ...
                    <select name="type" id="type" class="form-select" required>
                        <option value="percentage" {{ old('type') === 'percentage' ? 'selected' : '' }}>{{ __('cms.coupons.type_labels.percentage') }}</option>
                        <option value="fixed" {{ old('type') === 'fixed' ? 'selected' : '' }}>{{ __('cms.coupons.type_labels.fixed') }}</option>
                    </select>
                </div>
