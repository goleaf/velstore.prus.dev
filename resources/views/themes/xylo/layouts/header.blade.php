            ...
            <div class="col-md-8 col-6 text-end">
                <form class="d-flex justify-content-end" action="{{ url('/search') }}" method="GET">
                    <div class="input-group search-input-width">
                        ...
                        <button type="submit" class="btn btn-outline-secondary search-style"><i
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-4 d-flex justify-content-end align-items-center gap-3">
                ...
                <form action="{{ route('change.currency') }}" method="POST">
                    @csrf
                    <select name="currency_code" class="form-select form-select-sm font-style"
                ...
                <!-- Wishlist Icon -->
                <button type="button" class="text-dark homepage-icon btn btn-link p-0"
                        data-url="{{ auth()->check() ? route('customer.wishlist.index') : route('customer.login') }}">
                    <i class="fa-regular fa-heart"></i>
                </button>

                <!-- Account Icon -->
                <button type="button" class="text-dark dropdown-toggle homepage-icon btn btn-link p-0"
                ...
                <!-- Cart Icon -->
                <button type="button" class="text-dark position-relative homepage-icon btn btn-link p-0"
                        data-url="{{ route('cart.view') }}">
