...
class AdminPageViewTest extends TestCase
{
    ...
    public static function adminPageViewProvider(): array
    {
        return [
            ...
            'brands edit' => ['admin.brands.edit', ['brand' => fn (self $test) => $test->brand->id], 'admin.brands.edit'],
            ...
            'menu items edit' => ['admin.menus.items.edit', ['item' => fn (self $test) => $test->menuItem->id], 'admin.menu_items.edit'],
            ...
            'payment gateways edit' => ['admin.payment-gateways.edit', ['payment_gateway' => fn (self $test) => $test->paymentGateway->id], 'admin.payment_gateways.edit'],
