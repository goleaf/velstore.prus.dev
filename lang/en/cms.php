...
return [
    ...
    'dashboard' => [
        ...
        'shop_filter_label' => 'Focus on a shop',
        'shop_filter_placeholder' => 'Select a specific shop to drill into performance or view the full marketplace.',
        'shop_filter_apply' => 'View performance',
        'shop_filter_clear' => 'Reset',
        'shop_filter_all' => 'All shops',
        'shop_filter_active' => 'Filtering by :shop',
        'shops_total_label' => 'Marketplace shops',
        'shops_total_description' => 'Active storefronts participating in the marketplace.',
        'shops_active_breakdown' => ':active active • :inactive inactive',
        'shops_top_revenue_label' => 'Top revenue shop',
        'shops_top_revenue_description' => 'Generated :value in completed revenue during the current window.',
        'shops_top_revenue_empty' => 'No revenue recorded yet — invite vendors to start selling.',
        'shops_top_orders_label' => 'Top order volume',
        'shops_top_orders_description' => ':value orders placed during the selected window.',
        'shops_top_orders_empty' => 'Orders will appear here once transactions are completed.',
        'shops_table_title' => 'Shop performance overview',
        'shops_table_description' => 'Compare revenue, order volume, and unique customers across the busiest shops.',
        'shops_table_filtered' => 'Showing metrics for :shop',
        'shops_table_empty' => 'No shop performance data available yet.',
        'shops_table_column_shop' => 'Shop',
        'shops_table_column_revenue' => 'Revenue',
        'shops_table_column_orders' => 'Orders',
        'shops_table_column_customers' => 'Customers',
        'shop_status_active' => 'Active',
        'shop_status_inactive' => 'Inactive',
    ],
