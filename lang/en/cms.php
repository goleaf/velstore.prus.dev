...
return [
    ...
    'pages' => [
        ...
        'form_slug_label' => 'Page slug',
        'form_slug_generate' => 'Generate from default title',
        ...
        'form_visibility_label' => 'Visibility options',
        'form_visibility_navigation' => 'Show in navigation menu',
        'form_visibility_footer' => 'Show in footer links',
        'form_visibility_featured' => 'Feature on storefront home',
        'form_template_label' => 'Layout template',
        'form_template_default' => 'Standard layout',
        'form_template_hero' => 'Hero header layout',
        'form_publish_at_label' => 'Publish date',
        'form_publish_at_help' => 'Set a future publish date or leave empty to publish immediately.',
        ...
        'form_excerpt' => 'Excerpt (:code)',
        'form_content' => 'Content (:code)',
        'form_image' => 'Featured image (:code)',
        'form_image_help' => 'PNG, JPG or WEBP up to 2 MB.',
        'form_meta_title' => 'Meta title (:code)',
        'form_meta_description' => 'Meta description (:code)',
        'form_save' => 'Save page',

        // Edit Page
        'edit' => 'Edit page',
        'edit_description' => 'Update the translations, layout, and visibility rules for this page.',
