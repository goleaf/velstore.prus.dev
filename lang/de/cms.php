...
return [
    ...
    'brands' => [
        'heading' => 'Marken',
        'page_subtitle' => 'Verwalten Sie das Markenportfolio und seine Sichtbarkeit.',
        'id' => 'ID',
        'name' => 'Name',
        'description' => 'Beschreibung',
        'logo' => 'Logo',
        ...
        'massage_confirm' => 'Löschen bestätigen',
        'confirm_delete' => 'Sind Sie sicher, dass Sie diese Marke löschen möchten?',
        'massage_cancel' => 'Abbrechen',
        'massage_delete' => 'Löschen',
        'success' => 'Erfolg',
        'total_brands' => 'Marken insgesamt',
        'active_brands' => 'Aktive Marken',
        'inactive_brands' => 'Inaktive Marken',
        'discontinued_brands' => 'Eingestellte Marken',
        'search_label' => 'Marken suchen',
        'search_placeholder' => 'Nach Name oder Slug suchen…',
        'status_filter_label' => 'Status',
        'status_filter_all' => 'Alle Status',
        'status_filter_active' => 'Aktiv',
        'status_filter_inactive' => 'Inaktiv',
        'status_filter_discontinued' => 'Eingestellt',
        ...
        'apply_filters' => 'Filter anwenden',
        'reset_filters' => 'Filter zurücksetzen',
        'table_products' => 'Produkte',
        'table_translations' => 'Sprachen',
        'empty_state' => 'Keine Marken für die ausgewählten Filter gefunden.',
        'status_active' => 'Aktiv',
        'status_inactive' => 'Inaktiv',
        'status_discontinued' => 'Eingestellt',
    ],
