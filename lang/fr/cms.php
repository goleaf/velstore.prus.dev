...
return [
    ...
    'brands' => [
        'heading' => 'Marques',
        'page_subtitle' => 'Gérez le catalogue des marques et leur visibilité.',
        'id' => 'ID',
        'name' => 'Nom',
        'description' => 'Description',
        'logo' => 'Logo',
        ...
        'file_upload' => 'Téléverser un logo',
        'no_logo' => 'Sans logo',
        'choose_file' => 'Choisir un fichier',
        'image_preview' => 'Aperçu de l’image',
        ...
        'massage_delete' => 'Supprimer',
        'success' => 'Succès',
        'total_brands' => 'Nombre total de marques',
        'active_brands' => 'Marques actives',
        'inactive_brands' => 'Marques inactives',
        'discontinued_brands' => 'Marques arrêtées',
        'search_label' => 'Rechercher des marques',
        ...
        'status_filter_discontinued' => 'Arrêtée',
        'sort_label' => 'Trier par',
        'sort_latest' => 'Plus récentes d’abord',
        'sort_oldest' => 'Plus anciennes d’abord',
        'sort_name_asc' => 'Nom A-Z',
        'sort_name_desc' => 'Nom Z-A',
        'sort_products_desc' => 'Plus de produits',
        'apply_filters' => 'Appliquer les filtres',
        'reset_filters' => 'Réinitialiser les filtres',
        'table_products' => 'Produits',
        'table_translations' => 'Langues',
        'empty_state' => 'Aucune marque trouvée pour les filtres sélectionnés.',
        'status_active' => 'Active',
        'status_inactive' => 'Inactive',
        'status_discontinued' => 'Arrêtée',
    ],
