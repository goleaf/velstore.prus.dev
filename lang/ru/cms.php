...
return [
    ...
    'customers' => [
        ...
        'back_to_list' => 'Назад к клиентам',
        'details_title' => 'Данные клиента',
        'not_available' => 'Нет данных',
        'orders_count' => 'Заказы',
        'total_spent' => 'Всего потрачено',
        'wishlist_count' => 'Товары в списке желаний',
        ...
        'default_address_hint' => 'Используется как основной адрес доставки на витрине и в админке.',
        ...
        'no_addresses' => 'Для этого клиента адреса не указаны.',
        'address_created' => 'Адрес успешно сохранён.',
        'address_updated' => 'Адрес успешно обновлён.',
        'address_deleted' => 'Адрес успешно удалён.',
        'address_set_default' => 'Основной адрес обновлён.',

        // Orders
        'orders' => 'Заказы',
        'orders_table_id' => 'Заказ',
        'orders_table_status' => 'Статус',
        'orders_table_total' => 'Сумма',
        'orders_table_items' => 'Товары',
        'orders_table_placed_at' => 'Дата оформления',
        'orders_table_payment_status' => 'Последний платёж',
        'orders_table_action' => 'Действие',
        'view_order' => 'Просмотр заказа',
        'no_orders' => 'Для этого клиента заказы не найдены.',

        // Wishlist
        'wishlist_title' => 'Список желаний',
        'wishlist_product' => 'Товар',
        'wishlist_added_at' => 'Дата добавления',
        'no_wishlists' => 'У этого клиента нет товаров в списке желаний.',
        'product_missing' => 'Товар недоступен',

        // Reviews
        'reviews_title' => 'Отзывы о товарах',
        'reviews_product' => 'Товар',
        'reviews_rating' => 'Рейтинг',
        'reviews_status' => 'Статус',
        'reviews_submitted_at' => 'Дата отправки',
        'reviews_content' => 'Отзыв',
        'review_status_approved' => 'Одобрено',
        'review_status_pending' => 'Ожидает одобрения',
        'no_reviews' => 'Этот клиент ещё не оставил отзывов.',
    ],
    ...
    'product_reviews' => [
        ...
        'index_description' => 'Управляйте отзывами клиентов и поддерживайте доверие к каталогу.',
        'show_title' => 'Отзыв №:id',
        'details_title' => 'Детали отзыва',
        'back_to_list' => 'Вернуться к отзывам',
        ...
        'approved' => 'Одобрен',
        'pending' => 'Ожидает',
        'missing_customer' => 'Неизвестный клиент',
        'missing_product' => 'Неизвестный товар',
        'no_review_provided' => 'Для этого отзыва текст не был предоставлен.',
        ...
        'edit_title' => 'Редактировать отзыв №:id',
        'edit_form_title' => 'Обновить отзыв',
        'edit_description' => 'Измените рейтинг или статус одобрения этого отзыва.',
        'update_button' => 'Сохранить изменения',

        'confirm_delete' => 'Подтверждение удаления',
        'delete_message' => 'Вы уверены, что хотите удалить этот отзыв?',
        'delete' => 'Удалить',
        'cancel' => 'Отмена',

        'success_create' => 'Отзыв успешно создан!',
        'success_update' => 'Отзыв успешно обновлён!',
        'success_delete' => 'Отзыв успешно удалён!',
        'error_delete' => 'Ошибка при удалении отзыва! Попробуйте ещё раз.',
