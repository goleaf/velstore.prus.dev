...
class UpdateProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'variants.*.dimension' => 'nullable|string|max:50',
    ...
    public function messages(): array
    {
        return [
            ...
            'variants.*.weight.max' => 'Weight must not exceed 50 characters.',
            'variants.*.dimension.max' => 'Dimensions must not exceed 50 characters.',
