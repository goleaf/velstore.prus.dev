    ...
    public function run(): void
    {
        DB::transaction(function () {
            ...
            $shop = Shop::first() ?? Shop::create([
                ...
                'name' => 'Default Shop',
                'logo' => null,
                'description' => 'Auto-generated default shop',
                'status' => 'active',
            ]);
            ...
            foreach ($products as $item) {
                // Skip if product with this slug already exists to keep seeding idempotent
                ...
                // Use local asset path for image
                $localPath = $item['image'];
                $imageName = basename($localPath);
